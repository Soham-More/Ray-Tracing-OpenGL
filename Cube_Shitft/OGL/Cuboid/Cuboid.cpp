...
OGL::Cuboid::Cuboid(glm::vec3 Pos, glm::vec3 Size)
{
	...
	std::vector<unsigned int> Cuboid_Index;
	...
	Basic_Model.Scale(Size * 2.0f);

	this->Pos = Pos;
	this->Size = Size;
}

void OGL::Cuboid::move(glm::vec3 m)
{
	this->Pos += m;
	Basic_Model.SetPosition(Pos);
}

void OGL::Cuboid::Draw()
{
	Basic_Model.Draw();
}
